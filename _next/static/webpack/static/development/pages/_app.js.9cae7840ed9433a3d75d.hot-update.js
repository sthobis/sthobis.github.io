  ...
  _createClass(Layout, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.props.pathname !== nextProps.pathname) {
        this.timeout && clearTimeout(this.timeout); // this.animation.pause();
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.pathname !== this.props.pathname) {
        this.timeout = setTimeout(function () {// this.animateBackground(this.props.pathname);
        }, 1000);
      }
    }
  }, {
...
//# sourceMappingURL=_app.js.9cae7840ed9433a3d75d.hot-update.js.map