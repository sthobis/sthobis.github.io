...
function (_Component) {
  ...
  function ProjectsPage(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateProjectThumbnailImage", function () {
      ...
      var translateY = ["-".concat(prevProjectIndex * 100 / (_config__WEBPACK_IMPORTED_MODULE_3__["projects"].length * 100), "%"), "-".concat(currentProjectIndex / _config__WEBPACK_IMPORTED_MODULE_3__["projects"].length * 100, "%")];
...
//# sourceMappingURL=projects.js.acc08dab542ba3e8a25e.hot-update.js.map