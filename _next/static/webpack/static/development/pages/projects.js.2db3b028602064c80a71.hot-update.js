...
function (_Component) {
  ...
  function ProjectsPage(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateProjectThumbnailImage", function () {
      ...
      var translateY = ["".concat(prevProjectIndex * 100, "%"), "-".concat(currentProjectIndex * 100, "%")];
      animejs__WEBPACK_IMPORTED_MODULE_1___default()({
...
//# sourceMappingURL=projects.js.2db3b028602064c80a71.hot-update.js.map