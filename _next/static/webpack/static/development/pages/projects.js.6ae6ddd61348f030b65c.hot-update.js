...
function (_Component) {
  ...
  function ProjectsPage(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "animateProjectThumbnailImage", function () {
      ...
      var translateY = ["-".concat(prevProjectIndex * 100 / (_config__WEBPACK_IMPORTED_MODULE_3__["projects"].length * 100), "%"), "-".concat(currentProjectIndex * 100 / (_config__WEBPACK_IMPORTED_MODULE_3__["projects"].length * 100), "%")];
...
//# sourceMappingURL=projects.js.6ae6ddd61348f030b65c.hot-update.js.map